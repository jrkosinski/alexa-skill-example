...
const configUtil = require('alexa-common').config;
...
module.exports = {
    ...
    ui: {
        launchPrompt: getUISetting('LAUNCH_PROMPT', {
            text: 'Welcome to the Alexa Skill version {version}. Say help to get a list of commands. ',
        ...
        getVersion: getUISetting('GET_VERSION', {
            text: 'Example Alexa Skill version {version}',
            reprompt: null,
            card: 'Get Version'
        }),
