...
const app = alexa.createApp('alexa-alexa-skill', { shouldEndSessionByDefault: false });

const dataAccess = require('alexa-data-access');
...
//      call support
//
addAppIntentAsync(config.intents.callSupport, (context, slots, session, data) => {
    return await(phone.callSupport(context)); 
});
